...
int ssd1306_display_init(struct ssd1306_i2c_module *module)
{
	...
	ssd1306_print_string(module, "WELCOME TO LamLNK2\n");

	ssd1306_set_cursor(module, 2, 0);
	ssd1306_print_string(module, "SoC chip Arm335x\n");


	ssd1306_set_cursor(module, 4, 0);
	ssd1306_print_string(module, "kernel 5.4.257-bone68\n");



	ssd1306_set_cursor(module, 6, 0);
