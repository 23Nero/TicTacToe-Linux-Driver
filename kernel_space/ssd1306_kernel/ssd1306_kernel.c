...
#define DRIVER_DESC "ssd1306 driver for tictactoe game on beaglebone black"
...
static int ssd1306_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    ssd1306_print_string(module_ssd, "  4|5|6  Made LamLNK2\n");
...
static int ssd1306_remove(struct i2c_client *client)
{
    ...
    ssd1306_set_cursor(module_ssd, 3, 0);
    ssd1306_print_string(module_ssd, "LamLNK2 - Goodbye!\n");
    msleep(3000);
    ssd1306_clear_full(module_ssd);
