...
//             // Ghi dữ liệu vào tập tin để luồng chính có thể đọc
//             FILE *file = fopen("move.txt", "w");
//             if (file != NULL)
//             {
//                 fprintf(file, "%s\n", buf);
//                 fclose(file);
...
int main()
{
    ...
    // // Tạo luồng thread để đọc từ thiết bị
    // if (pthread_create(&thread, NULL, readFromDevice, NULL) != 0)
    // {
